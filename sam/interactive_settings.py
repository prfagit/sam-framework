...
class InteractiveSettingsManager:
    ...
    def _create_settings_definitions(self) -> List[SettingDefinition]:
        ...
        return [
            ...
            SettingDefinition(
                ...
                setting_type=SettingType.CHOICE,
                choices=["claude-3-5-sonnet-latest", "claude-3-opus-latest", "claude-3-haiku-latest"],
    ...
    def _get_setting_categories(self) -> Dict[str, List[SettingDefinition]]:
        ...
        for setting in self.settings_definitions:
            ...
            elif setting.key in ["MAX_TRANSACTION_SOL", "DEFAULT_SLIPPAGE", "SAM_FERNET_KEY", "RATE_LIMITING_ENABLED"]:
                categories["🔐 Security & Limits"].append(setting)
            elif setting.key in ["SAM_SOLANA_RPC_URL", "SAM_WALLET_PRIVATE_KEY", "SAM_DB_PATH", "OPENAI_BASE_URL", "LOCAL_LLM_BASE_URL"]:
    ...
    def show_interactive_settings(self) -> bool:
        ...
        while True:
            ...
            category_choices = list(categories.keys()) + ["💾 Save & Exit", "❌ Exit without saving"]
        ...
        try:
            if setting.setting_type == SettingType.BOOLEAN:
                ...
                new_value = inquirer.list_input(
                    ...
                    default=setting.current_value if setting.current_value in setting.choices else setting.choices[0]
                )
                ...
                new_value = inquirer.text(
                    prompt_text,
                    default=str(setting.current_value) if setting.current_value else ""
                )
